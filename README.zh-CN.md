...
🧪 **一整个评审团，而非一家之言** —— 五位专家评审（结构、论证、证据、语言、原创性）各从自己的视角批评，再在**反驳轮**里互相辩论，最后由仲裁者统合。正是这种交叉质询，筛掉"看似有理、实则站不住"的意见，让真正重要的问题更突出。
...
六个阶段 —— **接收 → 5 位专家 → 反驳轮 → 仲裁 → 主编信 → 评分卡** —— 与正式版背后是同一套评审流程。
